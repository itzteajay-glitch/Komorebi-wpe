...
current - program to do something

# SYNOPSIS

**current** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**current** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **current** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**current** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    current. See **foo.conf**(5) for further details.
...
**current** provides some return codes, that can be used in scripts:
...
TJ Hoth <itzteajay@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 TJ Hoth
